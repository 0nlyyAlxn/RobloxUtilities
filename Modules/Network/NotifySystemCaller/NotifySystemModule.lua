...
if game:GetService("RunService") then
	...
	STX_Nofitication.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
	...
	STX_Nofitication.Name = "STX_Nofitication"
	STX_Nofitication.Parent = game:GetService("CoreGui")
...
function NotifySystemModule:Notify(nofdebug, middledebug, all)
	...
	repeat task.wait() until GUI ~= nil
